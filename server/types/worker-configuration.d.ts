/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/types/worker-configuration.d.ts` (hash: 9ce9b6fd347ec4b1de9e3cd3b9bbc112)
// Runtime types generated with workerd@1.20250604.0 2025-06-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_KEY: "f67sd6f7dsf5";
		MAX_FILE_SIZE: "300";
		MAX_TOTAL_SIZE: "300";
		MAX_FILES: "10";
		CHUNK_SIZE: "50";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_KEY" | "MAX_FILE_SIZE" | "MAX_TOTAL_SIZE" | "MAX_FILES" | "CHUNK_SIZE" | "CHUNK_THRESHOLD" | "MAX_CONCURRENT">> {}
}
