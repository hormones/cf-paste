/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/platforms/cloudflare/worker-configuration.d.ts` (hash: a1e1c64b029f3aa305731bd6737ee79b)
// Runtime types generated with workerd@1.20250709.0 2025-06-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_KEY: "ajsdgjasdgahsjadhg";
		ADMIN_DASH_PASSWORD: "your_admin_password_here";
		MAX_FILE_SIZE: "300";
		MAX_TOTAL_SIZE: "300";
		MAX_FILES: "10";
		CHUNK_SIZE: "50";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_KEY" | "ADMIN_DASH_PASSWORD" | "MAX_FILE_SIZE" | "MAX_TOTAL_SIZE" | "MAX_FILES" | "CHUNK_SIZE" | "CHUNK_THRESHOLD" | "LANGUAGE">> {}
}
